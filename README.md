...
Тестовые задания в виде архивов, ссылок на файловые хостинги и подобном (то есть **не** репозиторий) рассматриваться не будут. Ссылку на репозиторий и ваше имя необходимо отправить на электропочту [d.ivanov@smartofood.ru](mailto:d.ivanov@smartofood.ru) с темой письма «Тестовое задание».